  ...
  days: [
    {
      ...
      schedule:[
        ...
        { time:"10:30", text:"登米兰大教堂 + 屋顶露台", ticket:true, next:{ type:"walk", desc:"步行1分钟" } },
        { time:"12:30", text:"埃马努埃莱二世长廊午餐 · 斯卡拉广场", next:{ type:"walk", desc:"步行约12分钟" } },
        { time:"14:00", text:"斯福尔扎城堡 · 森皮奥内公园", next:{ type:"walk", desc:"步行约25分钟" } },
        { time:"15:00", text:"Hotel Charly 正式入住" },
        { time:"16:00", text:"（可选）Navigli 运河区散步", next:{ type:"metro", desc:"地铁回中央站" } },
        { time:"晚上",  text:"老城晚餐（意面/烩饭/炖牛膝）" }
      ],
      activities:[
        { time:"08:00", name:"抵达 MXP T1 · 入境取行李", note:"国泰 CX233（香港00:50起飞）直飞落地约08:00 | 深圳需前一晚经跨境巴士/口岸大巴过境至香港机场，预留充足过关时间 | 入境申根盖章，备好酒店单/回程票以备询问", transport:"落地" },
        ...
        { time:"10:30", name:"登米兰大教堂 + 屋顶露台", img:"images/milan.jpg", duration:"2小时", cost:240, note:"屋顶可眺望阿尔卑斯山脉，9月旺季无票排队60-90分钟，有票直接进", ticketTip:"建议出发前3-4周购票 | 9:00开门前15分钟到场 | 旺季无票排队约60-90分钟", booking:[{ name:"大教堂官网", url:"https://ticket.duomomilano.it/en" },{ name:"Klook", url:"https://www.klook.com/zh-CN/activity/2494-milan-duomo-cathedral-terrace-ticket/" }] },
        ...
        { time:"15:00", name:"Hotel Charly 正式入住", note:"中央站步行5分钟" },
    ...
    },
    {
      ...
      schedule:[
        ...
        { time:"13:00", text:"Essential by Dorint 入住", next:null },
        { time:"13:30", text:"午餐" },
      ...
      activities:[
        ...
        { time:"13:00", name:"Essential by Dorint 入住", note:"从东站坐1站到西站(约3分钟)，酒店在西站旁，行李放下休息片刻" },
    ...
    },
    {
      ...
      schedule:[
        ...
        { time:"14:15", text:"Hotel St. Josef 入住" },
